Vue.component('sidebar_1721710185', { template: `<nav class="fixed top-0 left-0 w-fit h-full bg-gray-100 space-y-8 sm:w-80 pt-10 text-black z-20">
      ...
      <div>
        ...
        <div class="py-4 px-4 w-fit border-t border-black">
          <div class="flex items-centergap-x-4">
            <div>
              <span class="block text-white-700 text-sm font-semibold">Monitor New Ethereum Transactions</span>
              <a href="javascript:void(0)" class="block mt-px text-white-600 text-xs">Stay up-to-date on all incoming ether transfers</a>
            </div>
          </div>
        </div>
      </div>
